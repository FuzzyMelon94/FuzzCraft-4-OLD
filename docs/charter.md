...
| 7 | QoL & Final Compat | 🔄 In Progress | v0.7.1. Wave 1: RightClickHarvest, TorchMaster, Particle Effects, Naturally Trimmed, Trimmable Tools, Clumps, Reese's Sodium Options (1.8.3), Collapsible Groups (JEI/CF). Curios slots (2 back/4 ring/4 charm). ModernFix dynamic_resources enabled. AU Tropicraft fix committed. Wave 2 (~51 mods) queued for B7b branch — full QoL pass (Dynamic FPS, VeinMiner, GraveStone, Better Days, Polymorph, Carry On, etc. — see configs.md). KubeJS deferred to B8. Hybrid Aquatic re-add candidate. |
---
## 8. Issue & Debug Log
