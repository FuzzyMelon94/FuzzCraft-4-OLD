...
| 5c | Dimensions — Underground & Quirky | 🔄 In Progress | Undergarden 0.9.6 + Deeper and Darker 1.4.1 + The Bumblezone 7.15.0 added (v0.5.7). DT compat gap confirmed (no addon for any B5c mods). No Farmer's Cutting datapacks exist for B5c mods. SP testing in progress. |
